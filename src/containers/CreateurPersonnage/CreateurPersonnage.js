...
class CreateurPersonnge extends Component {
    state = {
        personnage: {
            image: 1,
            force: 0,
    ...
    componentDidMount = () => {
        ...
        axios.get("https://creapersocc-default-rtdb.firebaseio.com/armes.json")
            .then(reponse => {
    ...
    handleValidation = () => {
        ...
        axios.post("https://creapersocc-default-rtdb.firebaseio.com/persos.json", player)
            .then(reponse => {
                console.log(reponse)
    ...
    render() {
        return (
            <div className='container'>
                ...
                {
                    this.state.armes && <div>Chargement...</div>
                }
...
export default CreateurPersonnge;